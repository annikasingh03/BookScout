...
int main() {
    ...
    try {
        ...
        std::string filename = "/Users/tatumbowen/Desktop/Frankenstein.txt"; // Update with the correct path
        // read file
        ...
        system("python /Users/tatumbowen/CLionProjects/BookMap/wordCloud.py top_words.txt");
